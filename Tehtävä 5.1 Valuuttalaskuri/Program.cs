...
namespace Tehtävä_5._1_Valuuttalaskuri
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //if:llä aletaan tarkistelemaan lukua. int muuttjuhalla on määritelty arvo joka on luku ja tässä ifi:llä
            //todetaan, että luku on yhtäkun  numero 1:i.perustettu oma alueen {} luku 1 on dollari. 
            //muutetaan luku -> String.Format käskyllä stringiksi ja laskukaava sekä + $. 
            if (luku == 1)
            {
